...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
      ...
      if ($this->user->hasPermission('access', 'catalog/category_services')) {
        $services[] = array(
          'name'	   => $this->language->get('text_category_services'),
          'href'     => $this->url->link('catalog/category_services', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }

			if ($this->user->hasPermission('access', 'catalog/services')) {
        $services[] = array(
          'name'	   => $this->language->get('text_services'),
          'href'     => $this->url->link('catalog/services', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }

      if ($this->user->hasPermission('access', 'catalog/services_featured')) {
        $services[] = array(
          'name'	   => $this->language->get('text_services_featured'),
          'href'     => $this->url->link('catalog/services_featured', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }
      ...
      if ($this->user->hasPermission('access', 'setting/branch')) {
				$system[] = array(
					'name'	   => $this->language->get('text_branch'),
					'href'     => $this->url->link('setting/branch', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
