...
class ControllerStartupSeoUrl extends Controller {
	public function index() {
		...
		if (isset($this->request->get['_route_'])) {
			...
			foreach ($parts as $part) {
				...
				if ($query->num_rows) {
					...
					if ($url[0] == 'services_id') {
						$this->request->get['services_id'] = $url[1];
					}

					if ($url[0] == 'featured_services_id') {
						$this->request->get['featured_services_id'] = $url[1];
					}

					if ($query->row['query'] && $url[0] != 'information_id' && $url[0] != 'services_id' && $url[0] != 'featured_services_id' && $url[0] != 'manufacturer_id' && $url[0] != 'category_id' && $url[0] != 'product_id') {
			...
			if (!isset($this->request->get['route'])) {
				if (isset($this->request->get['product_id'])) {
					...
					$this->request->get['route'] = 'product/services';
				} if (isset($this->request->get['featured_services_id'])) {
					$this->request->get['route'] = 'product/services_featured';
		...
		// Redirect 301
			...
			} elseif ($this->request->get['route'] == 'product/services' && isset($this->request->get['services_id'])) {
				$route = 'services_id=' . (int)$this->request->get['services_id'];
			} elseif ($this->request->get['route'] == 'product/services_featured' && isset($this->request->get['featured_services_id'])) {
				$route = 'featured_services_id=' . (int)$this->request->get['featured_services_id'];
